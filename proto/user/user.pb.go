...
type SendVerifyCodeResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// task_id 异步任务 ID，可用 WatchTask 订阅发送进度（网关对应 SSE 端点）。
...
func (x *SendVerifyCodeResponse) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *SendVerifyCodeResponse) GetExpiresIn() int64 {
	if x != nil {
		return x.ExpiresIn
	}
	return 0
...
// WatchTaskRequest 订阅任务进度请求。
type WatchTaskRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TaskId        string                 `protobuf:"bytes,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"` // SendVerifyCode 返回的任务 ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// TaskEvent 任务进度事件。status 为终态（success / failed）后流结束。
type TaskEvent struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	TaskId string                 `protobuf:"bytes,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	// status 任务状态：pending（已入队）/ sending（发送中）/ retrying（重试中）/ success / failed
	Status string `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
	// message 面向用户的友好提示，可直接展示
	Message       string `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`
	UpdatedAt     int64  `protobuf:"varint,4,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"` // 状态更新时间（Unix 秒）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TaskEvent) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
type ChangeEmailRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Uuid          string                 `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`                         // 用户 uuid（网关从 token 解析）
	NewEmail      string                 `protobuf:"bytes,2,opt,name=new_email,json=newEmail,proto3" json:"new_email,omitempty"` // 新邮箱，必填
	Code          string                 `protobuf:"bytes,3,opt,name=code,proto3" json:"code,omitempty"`                         // 新邮箱收到的 change_email 场景验证码
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChangeEmailRequest) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
const file_proto_user_user_proto_rawDesc = "" +
	...
	"\vis_new_user\x18\a \x01(\bR\tisNewUser2\x85\x16\n" +
	"\vUserService\x129\n" +
	...
	"\x0eSendVerifyCode\x12\x1b.user.SendVerifyCodeRequest\x1a\x1c.user.SendVerifyCodeResponse\x126\n" +
	"\tWatchTask\x12\x16.user.WatchTaskRequest\x1a\x0f.user.TaskEvent0\x01\x12@\n" +
...
var file_proto_user_user_proto_goTypes = []any{
	...
	(*WatchTaskRequest)(nil),                // 8: user.WatchTaskRequest
	(*TaskEvent)(nil),                       // 9: user.TaskEvent
	...
	(*ChangeEmailRequest)(nil),              // 25: user.ChangeEmailRequest
	(*ChangeEmailResponse)(nil),             // 26: user.ChangeEmailResponse
...
var file_proto_user_user_proto_depIdxs = []int32{
	...
	8,  // 27: user.UserService.WatchTask:input_type -> user.WatchTaskRequest
	...
	23, // 35: user.UserService.ResetPassword:input_type -> user.ResetPasswordRequest
	25, // 36: user.UserService.ChangeEmail:input_type -> user.ChangeEmailRequest
	...
	9,  // 67: user.UserService.WatchTask:output_type -> user.TaskEvent
	...
	24, // 75: user.UserService.ResetPassword:output_type -> user.ResetPasswordResponse
	26, // 76: user.UserService.ChangeEmail:output_type -> user.ChangeEmailResponse
